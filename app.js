  ...
  methods: {
    ...
    attackMonster() {
      ...
      if (this.monsterHealth < this.playerHealth) {
        this.healMonster();
      } else if (this.mayUseSpecialAttack) {
        this.specialAttackPlayer();
      } else {
        this.attackPlayer();
      }
      const attackValue = getRandomValue(1, 15);
    ...
    specialAttackMonster() {
      ...
      const attackValue = getRandomValue(1, 25);
      this.monsterHealth -= attackValue;
      this.addLogMessage("player", "special attack", attackValue);
    },
    specialAttackPlayer() {
      console.log("specialAttackPlayer");
      const attackValue = getRandomValue(1, 25);
      this.playerHealth -= attackValue;
    ...
    healPlayer() {
      ...
      const healValue = getRandomValue(1, 20);
